...
Alice*Shout(angry): To hurl insults and threats at me!  
Alice*Shout(angry): Just who are you anyway?  
\>>  
Narrator: The woman draws herself up proudly, to her full height, and sneers at you.  
\*Anne Name Anne Mazarin  
Anne*Shout(angry): I am Anne Mazarin!  
Anne(angry): And I belong here, unlike you!  
Anne(angry): Because I am Armand's <i>fiancee</i>!  
\*Stop Music  
\*Play Music m_fogmonster  
...
Alice*Think(sad): Armand is <i>engaged</i>.  
#### B  
Alice*Think(angry): I don't care about him, anyway.  
Alice*Think(sad): Men are all the same...  
\***  
Anne: Cat got your tongue now, huh?  
Narrator: She crosses her arms and smirks self-satisfactorily.  
Alice*Think(angry): Can there be a more unpleasant woman than this?  
\>>  
...
\*Stop Music  
\*Play Sound s_human_hit_body  
Alice(sad): {*Attention Ouch!}  
\*Camera Left 2  
...
#### B  
Alice*Think(angry): She must be making this up!  
Alice*Think(sad): If he was really engaged, he would have mentioned it... wouldn't he?  
\***  
Alice*Think(sad): Ugh, I can't stand the smell of her perfume!  
\>  
...
Alice*Think: That's much better.  
...
Alice*Think(sad): What a crazy day... I wonder what tomorrow will be like?  
Alice*Think: But there's no point wondering, guess I'll find out soon enough.  
Alice*Think: I should really get some sleep now.  
\*Camera Left 2  
...
Alice*Think: Wow, it wasn't a dream after all.  
Alice*Think: I'm still in 1664.  
Alice*Think: I wonder what time it is?  
...
\>>  
Alice*Think(sad): The battery is dead, I can't even tell the time!  
\>  
...
Alice(surprise): {*Attention <i><b>What???</b></i>}  
Jeanne(sad): Shhh!  
...
Jeanne(sad): And she'll do <i>anything</i> to get rid of anyone in her way.  
...
### \*Goto wearrosegolddress (Condition: ROSEGOLD_DRESS >= 1)  
...
\>  
### \*Goto admiredress (Condition: ROSEGOLD_DRESS >= 1)  
...
\*Play Sound s_female_laughter_01  
Anne(surprise): <i>Whatever</i> are you wearing??  
...
### \*Goto previouslywarned (Condition: JEANNE_WARNING >= 1)  
### \*Goto noidea (Condition: NO_TEA >= 1)  
# previouslywarned  
Alice*Think: She is definitely up to something!  
\*Stop Music  
\*Play Music m_intense_classical_tension_rage_bellissimo_01  
...
Alice*Think(sad): I think that Anne just scored points wih Armand.  
Alice*Think(sad): If only I knew what she had done before... that Jeanne wanted to tell me about.  
### \*Goto eatinsilence  
# eatinsilence  
\*Stop Music  
...
Alice*Think(sad): Sure, and not because you're just sticking like superglue to Armand's side.  
...
\>  
\*Play Sound s_flap_01  
\*Stop Sound  
\*Play Sound s_crash_01  
...
\>>  
Alice*Think: Now that I'm finally alone with Armand...  
Alice*Think: It's my chance to find out exactly what's going on between Armand and Anne!  
\>  
\*Stop Music  
...
#### B  
Alice*Think(sad): Better not pry into his personal affairs.  
...
\*Stop Music  
\*Play Music m_intense_classical_tension_rage_bellissimo_02  
Armand(surprise): <i>Waiting for you</i>? What did she want?  
Alice(sad): She told me that she was your fiancee...  
\>>>  
Armand(surprise): <i><b>She said what???</b></i>  
...
\>>  
Armand(happy): {*Joyful <i><b>Hahahaha!</b></i>}  
Alice(smile): Hey! It was really harrowing.  
Armand(smile): I'm sorry, I'm sure it was.  
Armand(smile): And don't worry. You're coming with <i>me</i> now.  
...
### \*Goto knowgossip (Condition: STAY_GARDEN >= 1)  
### \*Goto nogarden  
# nogarden  
...
### \*Goto continuejeanne  
# knowgossip  
Alice*Think: She must be talking about what Armand was telling me in the garden...  
Alice*Think(sad): Rumours and suspicions about the King's brother being the one who did it, are spreading.  
# continuejeanne  
\>  
...
\***  
\*Condition  
## A. (Condition: Alice Outfit = Blue_Silk_Dress)  
#### A  
\*Gain BLUESILK_DRESS  
...
\***  
\*Condition  
## A. (Condition: Alice Hair = Long_Romantic_Curls)  
## B. (Condition: Alice Hair = Elegant_Updo)  
#### A  
\*Gain NEW_HAIR  
#### B  
\*Gain NEW_HAIR  
\***  
### \*Goto lookgood (Condition: BLUESILK_DRESS >= 1)  
### \*Goto lookdull (Condition: BROWN_DRESS >= 1)  
# lookgood  
...
\*Condition  
## A. (Condition: NEW_HAIR >= 1)  
## B. (Condition: NEW_HAIR = 0)  
#### A  
...
\>>R  
Alice*Think: Armand must be thinking about the King, and the assassination attempt.  
...
Alice*Think: Gosh... it's bumpy riding in a carriage!  
Alice*Think: Luckily the seats are well padded with cushions!  
\*Stop Sound  
Narrator: Just then, you manage to catch Armand's eyes, and he focuses his attention on you...  
### \*Goto armandcompliment (Condition: BLUESILK_DRESS >= 1)  
### \*Goto notimpressed (Condition: BROWN_DRESS >= 1)  
# armandcompliment  
...
### \*Goto checkhair  
# checkhair  
### \*Goto noticehair (Condition: NEW_HAIR >= 1)  
### \*Goto continueride (Condition: NEW_HAIR = 0)  
# noticehair  
...
Alice*Think(smile): I still can't believe that I'm here.  
...
Anne: My father.  
Alice*Think: Yes, Jeanne told me about that. That's why Anne lives in the Palace.  
...
Alice*Think(sad): It's awful to see Armand so sad and worried...  
Alice*Think(sad): Actually this entire thing is awful.  
Alice*Think(sad): Poisoning, the King's brother being suspected of it...  
Alice*Think(sad): I wish there was something I could do to help.  
\>  
\*Stop Music  
...
Anne: You have to sit <i>this way</i>, to balance yourself properly.  
...
Anne(smile): <i>Never ridden in a carriage before?</i>  
